...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("PUT /api/v1/app/sessions/{id}/project", s.requireFull(s.handleAPISessionProject))
	...
	mux.HandleFunc("POST /api/v1/app/account/bots", s.requireUserAccount(s.handleCreateBot))
	mux.HandleFunc("POST /api/v1/app/account/bots/{bot_id}/tokens", s.requireUserAccount(s.handleCreateBotToken))
	mux.HandleFunc("DELETE /api/v1/app/account/bots/{bot_id}/tokens/{token_id}", s.requireUserAccount(s.handleRevokeBotToken))
	mux.HandleFunc("DELETE /api/v1/app/account/bots/{bot_id}", s.requireUserAccount(s.handleDeleteBot))
