...
//
//   - on GitHub, source links such as `./glossary.md`
...
//     engineering docs, the root README) become GitHub blob URLs.
//
...
const REPO = "https://github.com/jssblck/akari";
...
function rewrite(href) {
  ...
  if (resolved.startsWith(`${BASE_DIR}/`) && resolved.endsWith(".md")) {
    ...
    const route = name === "index" ? "/guide" : `/guide/${name}`;
    return `${route}${hash}`;
  }
